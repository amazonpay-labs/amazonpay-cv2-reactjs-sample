...
function MainPage() {
  const scriptStaus = useScript("https://static-na.payments-amazon.com/checkout.js");
    ...
    fetch("/buttonSignature")
      ...
      .then((res) => {
        ...
        if(scriptStaus === "ready"){
          ...
          console.log("CreatCheckoutConfig:", JSON.stringify(createCheckoutSessionConfig));
        }
    ...
    const RenderPayButton = (signature, payloadJSON) => {
      ...
      window.amazon.Pay.renderButton(
        '#AmazonPayButton',
        {
          ...
          publicKeyId: process.env.REACT_APP_PUBLIC_KEY,
          ledgerCurrency: 'USD',
      ...
      <div className="App">
        ...
        <body className="App-body">
          ...
          <div style={{padding:"3rem", justifyContent:"center"}}>
            <div id="AmazonPayButton" style={{position: "relative", top: "50%"}}></div>
          </div>
